         ...
         */
            ...
            axios.put('/api/board', data)
                .then(async response => {
                    ...
                    // 글쓰기 성공 처리
                    alert("수정하기 성공");
                    location.href = '<%=ctxPath%>/board/view/' + savedId; // 작성된 게시물 페이지로이동
                })
                .catch(error => {
                    console.log(error);
                    // 글쓰기 실패 처리
...
<div style="display: flex;">
    <div style="margin: auto; padding-left:3%;">
        <h2 style="margin-bottom: 30px">수정하기</h2>
        <form name="addFrm">
            <table style="width: 1024px" class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="subject" size="100" maxlength="200" value="${board.title}"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" name="pw" maxlength="20" value="${board.password}" />
                    </td>
                </tr>

            </table>
            <div style="margin: 20px;">
                <button type="button" class="btn btn-secondary btn-sm mr-3" id="btnModify" >수정하기</button>
