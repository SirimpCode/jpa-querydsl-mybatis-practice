package com.github.jpaquerydslmybatis.service.music;
...
public class MusicTestService {
    ...
    public Object getMusicList(String keyword) {
        return webClientBuilder.build()
                .get()
                .uri("https://itunes.apple.com/search?term={keyword}&media=music&limit=10", keyword)
                .retrieve()
